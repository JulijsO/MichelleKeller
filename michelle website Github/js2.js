$(window).on("scroll touchmove", function () {
            if ($(".column").scrollTop() >= -0 + $('#img1').position().top && $(".column").scrollTop() < $('#img2').position().top) {
            ...
            if ($(".column").scrollTop() >= -100 + $('#img2').position().top && $(".column").scrollTop() < $('#img3').position().top) {
